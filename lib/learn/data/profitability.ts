...
export const profitabilityMetrics: MetricEntry[] = [
  {
    ...
    tagline:
      "How many rupees of operating profit the business squeezes from every ₹100 of capital it deploys.",
    ...
    concreteExample: {
      setup:
        "Company has ₹500 Cr equity + ₹300 Cr debt = ₹800 Cr capital employed. EBIT last year was ₹160 Cr.",
    ...
    formula: {
      plain:
        "ROCE = EBIT ÷ Capital Employed × 100, where Capital Employed = Total Equity + Total Debt − Cash",
    },
    inputs: [
      {
        name: "EBIT",
        meaning: "Operating profit before interest and tax",
        source: "P&L",
      },
      {
        name: "Total Equity",
        meaning: "Shareholders' funds (equity + reserves)",
    ...
    alternatives: [
      {
        name: "ROIC",
        whenBetter:
          "When you want to net out non-operating assets (excess cash, investments) for a purer view.",
      },
      {
        name: "ROE",
        whenBetter:
          "When you specifically care about shareholders' returns regardless of leverage.",
      },
    ],
    howToRead: [
      {
        label: "ROCE > 20%",
        desc: "Excellent. Strong competitive advantage or pricing power.",
      },
      {
        label: "ROCE 12–20%",
        desc: "Decent - comfortably above cost of capital. Value-creating.",
      },
      {
        label: "ROCE < 10%",
        desc: "Likely destroying value if cost of capital is higher. Investigate.",
      },
    ],
    ranges: {
      bad: "< 8%",
    ...
    sectorNotes: [
      {
        sector: "IT/Software",
        note: "Asset-light. 30%+ ROCE is normal - don't be impressed without comparing within sector.",
      },
      {
        sector: "Banks/NBFCs",
        note: "ROCE is structurally misleading for financials. Use ROA or ROE instead.",
      },
      {
        sector: "Power/Infra",
        note: "Long-gestation projects mean ROCE looks weak in build years; judge over a cycle.",
      },
    ],
    traps: [
  ...
  },
  {
    ...
    category: "profitability",
    tagline:
      "How much profit the company makes on every ₹100 of owners' money.",
    ...
    concreteExample: {
      setup:
        "A company has shareholders' equity of ₹1,000 Cr and reported net profit of ₹180 Cr.",
    ...
    inputs: [
      {
        name: "Net Profit",
        meaning:
          "Profit attributable to equity shareholders after tax and minority interest",
        source: "P&L",
      },
      {
        name: "Shareholders' Equity",
        meaning: "Equity share capital + reserves + retained earnings",
        source: "Balance Sheet",
      },
    ],
    methodology:
    ...
    alternatives: [
      {
        name: "ROCE",
        whenBetter:
          "When you want to judge operating efficiency without leverage tricks.",
      },
      {
        name: "5-year average ROE",
        whenBetter:
          "Always preferable to single-year ROE for stable conclusions.",
      },
    ],
    howToRead: [
      {
        label: "ROE > 20%",
        desc: "Strong. Management consistently delivers high returns.",
      },
      { label: "ROE 12–20%", desc: "Solid. Meaningfully above bank FD rates." },
      {
        label: "ROE < 10%",
        desc: "Weak. Compare with ROCE: if ROCE is higher, debt is dragging ROE; if ROCE is also low, the business itself is mediocre.",
      },
    ],
    ranges: {
      bad: "< 10%",
    ...
    sectorNotes: [
      {
        sector: "Banks/NBFCs",
        note: "Primary profitability metric. 15%+ is the bar; below 12% is weak.",
      },
      {
        sector: "Cyclicals",
        note: "ROE spikes at the cycle top. Always use 5-year averages.",
      },
    ],
    traps: [
  ...
  },
  {
    ...
    category: "profitability",
    tagline:
      "Of every ₹100 in sales, how many rupees survive as operating profit.",
    ...
    concreteExample: {
      setup:
        "Asian Paints reports revenue of ₹35,000 Cr and EBIT of ₹6,300 Cr.",
    ...
    inputs: [
      {
        name: "EBIT",
        meaning:
          "Revenue − raw materials − wages − other operating expenses − depreciation",
        source: "P&L",
      },
      {
        name: "Revenue",
        meaning: "Net sales (excluding excise/GST)",
        source: "P&L",
      },
    ],
    methodology:
    ...
    alternatives: [
      {
        name: "EBITDA Margin",
        whenBetter:
          "Comparing across companies with different asset bases or depreciation policies.",
      },
      {
        name: "Gross Margin",
        whenBetter: "To isolate pricing power from operating cost discipline.",
      },
    ],
    howToRead: [
      {
        label: "Rising OPM trend",
        desc: "Margins expanding - scale is kicking in or input costs are falling.",
      },
      {
        label: "Stable OPM",
        desc: "Mature business with disciplined cost management.",
      },
      {
        label: "Falling OPM",
        desc: "Competition or rising costs eating margin. Red flag if sustained for 4+ quarters.",
      },
    ],
    sectorNotes: [
      ...
      {
        sector: "Banks/NBFCs",
        note: "Use NIM (Net Interest Margin) instead - OPM doesn't apply meaningfully.",
      },
      {
        sector: "Commodity/Refining",
        note: "Single-digit OPM is normal; obsess about volume and crack spreads instead.",
      },
    ],
    traps: [
