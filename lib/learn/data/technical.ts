...
export const technicalMetrics: MetricEntry[] = [
  {
    ...
    concreteExample: {
      setup: "Stock was ₹500 (1 year ago), ₹250 (5 years ago), and is ₹600 today.",
      walkthrough: "1Y return = (600 ÷ 500) − 1 = 20%. 5Y return = (600 ÷ 250) − 1 = 140%; as CAGR = (600/250)^(1/5) − 1 = 19%/yr.",
      takeaway:
    ...
    inputs: [
      { name: "Start Price", meaning: "Adjusted close N years/months ago (adjusted for splits, bonus)", source: "Market" },
    ...
    howToRead: [
      { label: "Strong 1Y + weak 5Y", desc: "Recent rerating, not long-term value creation. Verify the rerating has fundamental support." },
      { label: "Weak 1Y + strong 5Y", desc: "Short-term dip in a compounding story — potentially an entry opportunity." },
      { label: "Strong 1Y AND strong 5Y", desc: "Established winner; valuation likely already reflects it." },
      { label: "Weak 1Y AND weak 5Y", desc: "Persistent underperformer. Ask whether the business has structural issues." },
    ],
    traps: [
