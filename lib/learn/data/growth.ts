...
export const growthMetrics: MetricEntry[] = [
  {
    ...
    alternatives: [
      { name: "Volume Growth", whenBetter: "When inflation or pricing is masking weak underlying demand." },
      { name: "Same-Store Sales Growth", whenBetter: "For retail/QSR where new-store openings inflate headline revenue." },
    ],
    howToRead: [
      { label: "Sales CAGR > 15%", desc: "Fast-growing. Verify it's not just acquisitions or margin-dilutive deals." },
      { label: "Sales CAGR 8–15%", desc: "Steady compounder — growing above GDP, likely gaining share." },
      { label: "Sales CAGR < 5%", desc: "Slow. Mature business, or stagnating one." },
    ],
    sectorNotes: [
      { sector: "Cyclicals", note: "Always use 5+ year CAGR — picking one cyclical high/low distorts everything." },
      { sector: "Banks", note: "Use loan-book growth (advances) instead of revenue." },
    ],
    traps: [
  ...
  },
  {
    ...
    concreteExample: {
      setup: "EPS went from ₹20 (FY20) to ₹46 (FY25). Share count was constant.",
    ...
    formula: { plain: "EPS = Net Profit ÷ Weighted Average Shares Outstanding; Growth measured as CAGR" },
    inputs: [
      { name: "Net Profit", meaning: "After tax, attributable to equity shareholders", source: "P&L" },
      { name: "Shares Outstanding", meaning: "Weighted average for the period (accounts for buybacks/issuances)", source: "Filings" },
    ],
    methodology:
    ...
    alternatives: [
      { name: "PAT Growth", whenBetter: "When you want absolute scale of profit growth, ignoring share count." },
      { name: "CFO Growth", whenBetter: "When you want to verify the EPS growth is backed by real cash." },
    ],
    howToRead: [
      { label: "EPS CAGR > 20%", desc: "Hyper-growth. Sustainable only with high ROCE and reinvestment runway." },
      { label: "EPS CAGR 12–20%", desc: "Strong compounder. Most multi-baggers fall here over decades." },
      { label: "EPS CAGR < 8%", desc: "Slow. Stock returns will likely lag unless valuation expands." },
    ],
    traps: [
