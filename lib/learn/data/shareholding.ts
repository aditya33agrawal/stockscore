...
export const shareholdingMetrics: MetricEntry[] = [
  {
    ...
    tagline:
      "How much of the company the founders / controlling family still own - and whether they're buying or selling.",
    inOneSentence:
    ...
    concreteExample: {
      setup:
        "A company's promoter holding history: Q1 FY24: 55%, Q1 FY25: 52%, Q1 FY26: 48%.",
    ...
    formula: {
      plain:
        "Promoter Holding = Shares held by promoter group ÷ Total shares outstanding × 100",
    },
    inputs: [
      {
        name: "Promoter shares",
        meaning:
          "Shares held by the controlling group, including family trusts and holding companies",
        source: "Quarterly Shareholding Pattern (BSE/NSE)",
      },
      {
        name: "Total shares",
        meaning: "All equity shares outstanding",
        source: "Filings",
      },
    ],
    methodology:
    ...
    howToRead: [
      {
        label: "Holding > 50%, stable or rising",
        desc: "Strongly aligned. Founders have skin in the game.",
      },
      {
        label: "Holding 25–50%",
        desc: "Normal for older or professionally-managed businesses. Watch the trend.",
      },
      {
        label: "Holding < 25%",
        desc: "Promoter influence is limited. Treat the company as professional-managed (different lens).",
      },
      {
        label: "Holding falling consistently",
        desc: "Demand a reason. 3+ quarters of selling is the threshold.",
      },
    ],
    traps: [
