...
export const balanceSheetMetrics: MetricEntry[] = [
  {
    ...
    tagline:
      "How much the company has borrowed relative to what owners have put in.",
    ...
    concreteExample: {
      setup:
        "A company has total debt of ₹400 Cr and shareholders' equity of ₹800 Cr.",
    ...
    inputs: [
      {
        name: "Total Debt",
        meaning: "Short-term + long-term borrowings (interest-bearing only)",
        source: "Balance Sheet",
      },
      {
        name: "Shareholders' Equity",
        meaning: "Equity capital + reserves",
        source: "Balance Sheet",
      },
    ],
    methodology:
    ...
    alternatives: [
      {
        ...
        whenBetter:
          "When you care about ability to service debt from operating cash flow.",
      },
      {
        name: "Interest Coverage",
        whenBetter:
          "When you want a direct read on whether interest is comfortably covered.",
      },
    ],
    howToRead: [
      {
        label: "D/E < 0.5",
        desc: "Low leverage. Company doesn't depend on borrowed money - can absorb shocks.",
      },
      {
        label: "D/E 0.5–1.5",
        desc: "Moderate. Normal for manufacturing. Not a concern on its own.",
      },
      {
        label: "D/E > 2",
        desc: "High. Fine for infra/financials; warning for consumer or commodity businesses.",
      },
    ],
    ranges: {
    ...
    sectorNotes: [
      {
        sector: "Banks/NBFCs",
        note: "Structurally 6–10x. Compare to peers, not to the rest of the market.",
      },
      {
        sector: "Infra/Real Estate",
        note: "2–4x is normal. Watch for project cash-flow timing.",
      },
      {
        sector: "IT/FMCG",
        note: "Usually near zero. Anything above 0.5 deserves a closer look.",
      },
    ],
    traps: [
  ...
  },
  {
    ...
    category: "balance-sheet",
    tagline:
      "Can the company pay what it owes within a year using what it already has?",
    inOneSentence:
    ...
    concreteExample: {
      setup:
        "A company has current assets of ₹3,000 Cr and current liabilities of ₹2,000 Cr.",
    ...
    inputs: [
      {
        name: "Current Assets",
        meaning:
          "Cash + receivables + inventory + other items due within 12 months",
        source: "Balance Sheet",
      },
      {
        name: "Current Liabilities",
        meaning:
          "Trade payables + short-term debt + other items due within 12 months",
        source: "Balance Sheet",
      },
    ],
    methodology:
    ...
    alternatives: [
      {
        name: "Quick Ratio",
        whenBetter:
          "When inventory might not be quickly saleable - strips inventory out of the numerator.",
      },
      {
        name: "Cash Ratio",
        whenBetter:
          "For a worst-case liquidity test using only cash and equivalents.",
      },
    ],
    howToRead: [
      {
        label: "Ratio > 2",
        desc: "Very liquid; potentially capital sitting idle.",
      },
      {
        label: "Ratio 1.2 – 2",
        desc: "Comfortable for most manufacturing businesses.",
      },
      {
        label: "Ratio < 1",
        desc: "Short-term liabilities exceed short-term assets. Investigate carefully - normal for FMCG, dangerous for others.",
      },
    ],
    sectorNotes: [
      {
        sector: "FMCG/Retail",
        note: "Often 0.8–1. They collect from customers fast and pay suppliers slowly - negative working capital is a strength.",
      },
      {
        sector: "Capital Goods",
        note: "1.5+ expected due to long inventory cycles.",
      },
    ],
    traps: [
