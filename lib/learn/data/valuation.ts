...
export const valuationMetrics: MetricEntry[] = [
  {
    ...
    concreteExample: {
      setup: "TCS trades at ₹3,800 per share. Its EPS (earnings per share) over the last 12 months is ₹125.",
      walkthrough: "P/E = ₹3,800 ÷ ₹125 = 30.4x. You are paying ₹30.40 for every ₹1 of current profit per share.",
      takeaway:
    ...
    inputs: [
      ...
      { name: "EPS", meaning: "Net profit available to equity holders, divided by shares outstanding", source: "P&L" },
    ],
    methodology:
    ...
    alternatives: [
      { name: "PEG", whenBetter: "When you want to factor in growth — a high P/E with high growth can be cheaper than a low P/E with no growth." },
      { name: "EV/EBITDA", whenBetter: "When comparing companies with very different debt levels or tax rates." },
      { name: "P/B", whenBetter: "For banks, NBFCs, and asset-heavy businesses where earnings are volatile but book value is stable." },
    ],
    howToRead: [
      { label: "Low P/E", desc: "Could be cheap — or the market expects earnings to fall. Always ask why." },
      { label: "High P/E", desc: "Market expects strong growth. You're paying upfront for future profits." },
      { label: "vs Industry P/E", desc: "The most useful comparison. 15x in banking is rich; 15x in IT is a bargain." },
    ],
    ranges: {
    ...
    sectorNotes: [
      { sector: "Banks/NBFCs", note: "P/E means less than P/B here. Bank earnings can swing with provisioning cycles." },
      { sector: "Cyclicals (metals, cement)", note: "Low P/E at the cycle top is a warning, not a bargain. EPS is temporarily inflated." },
      { sector: "High-growth IT/Pharma", note: "P/E of 35–45 can be reasonable if the company compounds EPS at 18%+." },
    ],
    traps: [
  ...
  },
  {
    ...
    concreteExample: {
      ...
      walkthrough: "P/B = ₹1,600 ÷ ₹520 = 3.08x. You're paying ₹3.08 for every ₹1 of net assets on the books.",
      takeaway:
    ...
    inputs: [
      { name: "Share Price", meaning: "Latest market price", source: "Market" },
      { name: "Book Value Per Share", meaning: "(Shareholders' Equity − Preferred Equity) ÷ Shares Outstanding", source: "Balance Sheet" },
    ],
    methodology:
    ...
    alternatives: [
      ...
      { name: "EV/EBITDA", whenBetter: "For comparing operating businesses with different debt structures." },
    ],
    howToRead: [
      { label: "P/B < 1", desc: "Market values the company below its accounting net worth. Often distressed; sometimes a real bargain." },
      { label: "P/B 1–3", desc: "Typical range for solid businesses earning a reasonable ROE." },
      { label: "P/B > 5", desc: "Justified only if ROE is consistently high (20%+). Otherwise rich." },
    ],
    sectorNotes: [
      { sector: "Banks/NBFCs", note: "Primary valuation metric. Cross-check with ROE — a bank trading at 2x P/B should earn at least 15% ROE." },
      { sector: "IT/Software", note: "P/B is misleading — book value barely reflects the actual business. Use P/E or EV/EBITDA." },
      { sector: "Capital goods/Steel", note: "P/B near 1 in a cyclical trough can be an entry point if balance sheet is clean." },
    ],
    traps: [
  ...
  },
  {
    ...
    term: "EV / EBITDA",
    category: "valuation",
    tagline: "What it would cost to buy the entire business — divided by its annual operating cash earnings.",
    ...
    concreteExample: {
      setup: "A company has market cap ₹10,000 Cr, debt ₹3,000 Cr, cash ₹500 Cr. EBITDA last year was ₹1,500 Cr.",
      walkthrough: "EV = 10,000 + 3,000 − 500 = ₹12,500 Cr. EV/EBITDA = 12,500 ÷ 1,500 = 8.3x.",
      takeaway:
    ...
    inputs: [
      { name: "Market Cap", meaning: "Share price × shares outstanding", source: "Market" },
      { name: "Debt", meaning: "Short-term + long-term borrowings", source: "Balance Sheet" },
      { name: "Cash", meaning: "Cash + cash equivalents + liquid investments", source: "Balance Sheet" },
      { name: "EBITDA", meaning: "Operating profit + depreciation + amortization", source: "P&L" },
    ],
    methodology:
    ...
    alternatives: [
      { name: "EV/EBIT", whenBetter: "When depreciation is a real economic cost (capital-intensive sectors)." },
      { name: "P/E", whenBetter: "When debt is negligible and you care about per-share economics." },
    ],
    howToRead: [
      { label: "EV/EBITDA < 8", desc: "Cheap on absolute basis. Verify EBITDA quality and growth." },
      { label: "EV/EBITDA 8–15", desc: "Typical for stable businesses with moderate growth." },
      { label: "EV/EBITDA > 20", desc: "Expensive — needs high growth or expanding margins to justify." },
    ],
    sectorNotes: [
      { sector: "Banks", note: "Don't use. EBITDA is meaningless for financial businesses." },
      { sector: "Capital-heavy (cement, steel, telecom)", note: "Preferred metric — neutralizes huge depreciation differences." },
    ],
    traps: [
  ...
  },
  {
    ...
    concreteExample: {
      setup: "Reliance Industries has roughly 676 Cr shares outstanding. Price ₹2,900.",
      walkthrough: "Market Cap = 676 × ₹2,900 ≈ ₹19,60,000 Cr (~₹19.6 lakh Cr).",
      takeaway: "Reliance is in the 'mega-cap' bucket — its sheer size dictates institutional ownership and slow but stable price action.",
    },
    formula: { plain: "Market Cap = Share Price × Total Shares Outstanding" },
    inputs: [
      { name: "Share Price", meaning: "Latest market price", source: "Market" },
      { name: "Shares Outstanding", meaning: "Total equity shares issued and not bought back", source: "Balance Sheet / Filings" },
    ],
    methodology:
    ...
    howToRead: [
      { label: "Large-cap (> ₹20,000 Cr)", desc: "Institutional coverage, deep liquidity, slower but steadier moves." },
      { label: "Mid-cap (₹5,000–20,000 Cr)", desc: "Often the growth sweet spot — large enough to research, small enough to compound." },
      { label: "Small-cap (< ₹5,000 Cr)", desc: "Less researched, less liquid. Higher risk; higher potential reward." },
    ],
    sectorNotes: [
      { sector: "Banks/NBFCs", note: "Use market cap × (1 + Debt/Equity) for a fairer comparison with non-financial peers." },
    ],
    traps: [
  ...
  },
  {
    ...
    concreteExample: {
      setup: "ITC trades at ₹450 and paid ₹15.50 in total dividends over the last 12 months.",
    ...
    formula: { plain: "Dividend Yield = Annual Dividend Per Share ÷ Current Share Price × 100" },
    inputs: [
      { name: "Annual Dividend Per Share", meaning: "Sum of dividends declared in the last 12 months", source: "Filings" },
      { name: "Share Price", meaning: "Latest market price", source: "Market" },
    ],
    methodology:
    ...
    alternatives: [
      { name: "Total Shareholder Yield", whenBetter: "When buybacks materially supplement dividends — add buyback yield to dividend yield." },
    ],
    howToRead: [
      { label: "Yield < 1%", desc: "Growth company reinvesting all profits. Don't hold for income." },
      { label: "Yield 2–4%", desc: "Mature, profitable business returning a sensible share of profits." },
      { label: "Yield > 6%", desc: "Either a true cash-cow utility/PSU — or the market is pricing in a dividend cut." },
    ],
    traps: [
