...
export const cashFlowMetrics: MetricEntry[] = [
  {
    ...
    category: "cash-flow",
    tagline: "How much of the reported profit actually became cash in the bank.",
    ...
    concreteExample: {
      setup: "Over the last 5 years, a company reported cumulative PAT of ₹2,000 Cr and cumulative CFO of ₹1,900 Cr.",
    ...
    formula: { plain: "CFO / PAT = Cumulative Cash Flow from Operations ÷ Cumulative Net Profit (over 5–10 years)" },
    inputs: [
      { name: "CFO", meaning: "Net cash generated from operating activities (from the cash flow statement)", source: "Cash Flow Statement" },
      { name: "PAT", meaning: "Profit after tax for the same period", source: "P&L" },
    ],
    methodology:
    ...
    alternatives: [
      { name: "FCF / PAT", whenBetter: "When you want to also account for capex required to sustain the business." },
      { name: "Accrual Ratio", whenBetter: "Academic version — focuses on the *change* in accruals; more useful for fraud detection." },
    ],
    howToRead: [
      { label: "> 90%", desc: "High-quality earnings. Profits convert to cash. Trust the P&L." },
      { label: "60 – 90%", desc: "Normal range for most businesses, especially during growth phases (working capital expanding)." },
      { label: "< 50% over 5+ years", desc: "Major red flag. Receivables or inventory are growing faster than business. Investigate hard." },
    ],
    sectorNotes: [
      { sector: "Banks/NBFCs", note: "CFO/PAT is not meaningful — financial businesses have a different cash-flow structure." },
      { sector: "Capital goods / Project-based", note: "Lumpy by nature. Use a 5-year rolling window, not single years." },
      { sector: "FMCG/IT", note: "Should consistently be near or above 100%. Anything sustained below 80% is a warning." },
    ],
    traps: [
