    ...
    <div className="mx-auto max-w-7xl px-4 sm:px-6 py-10">
      ...
      <section className="mb-8">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-3">
          {[0, 1, 2, 3, 4].map((i) => (
            <div key={i} className="border border-[rgb(var(--chalk-100)_/_0.06)] rounded-2xl p-4 space-y-2">
      ...
      <section className="mb-8">
        ...
        <div className="border border-[rgb(var(--chalk-100)_/_0.06)] rounded-2xl overflow-hidden">
          ...
          {Array.from({ length: 8 }).map((_, i) => (
            <div key={i} className="flex items-center gap-4 px-4 py-3.5 border-b border-[rgb(var(--chalk-100)_/_0.03)]">
      ...
      <section className="mb-8 grid gap-5 lg:grid-cols-2">
        <div className="border border-[rgb(var(--chalk-100)_/_0.06)] rounded-2xl p-6 h-[460px] flex flex-col gap-4">
